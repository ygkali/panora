...
pub struct Strings {
    ...
    pub settings_position: &'static str,
    pub settings_position_sub: &'static str,
    pub settings_position_pointer: &'static str,
    pub settings_position_center: &'static str,
...
static TR: Strings = Strings {
    ...
    settings_position: "Panel konumu",
    settings_position_sub: "X11 ve GNOME'da panelin açıldığı yer; Sway/Hyprland ui.layer_anchor ayarını kullanır",
    settings_position_pointer: "İşaretçinin yanında",
    settings_position_center: "Ekranın ortasında",
...
static EN: Strings = Strings {
    ...
    settings_position: "Panel position",
    settings_position_sub: "Where the panel opens on X11 and GNOME; Sway/Hyprland use ui.layer_anchor",
    settings_position_pointer: "Next to the pointer",
    settings_position_center: "Centre of the screen",
