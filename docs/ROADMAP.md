...
| QA-07 | Sırada; `docs/ROADMAP.md` §6 ve bu dosyanın başındaki uygulama brief'indeki faz sırasına göre ilerleniyor. STO-07 ve UI-05/06/07/08/14 bilinçli olarak bu oturumda bırakıldı (STO-07 gerçek makine gerektiriyor; UI-* GTK — bu ortamda görsel doğrulama yapılamıyor, ayrı takip görevleri olarak işaretlendi). |
