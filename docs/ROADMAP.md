...
| STO-07, UI-05, UI-06, UI-07, UI-08, UI-14, INT-05, PKG-03, QA-07 | Sırada; `docs/ROADMAP.md` §6 ve bu dosyanın başındaki uygulama brief'indeki faz sırasına göre ilerleniyor. STO-07 zaten bilinçli olarak atlanacak (WSL/CI'da anlamlı ölçülemez). |
